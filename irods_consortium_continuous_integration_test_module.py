...
# We can optionally define a script to be run by CI framework upon cloning the repository.
# When enabled, a relative path can be used to locate the script:
#
...
def init():
    ...
    # Below, an example: modifying, in-place, the test command line in docker-compose.yml file
    #  to spool output (1000s of lines per second) to a logfile instead of the console.
